...
%pl w szczególności: serwerów w architekturach SPARC orax X64 (klasy
%pl Entry-Level, Midrange, CoolThreads, stacji roboczych),
...
%en SPARC and X64 architectures (Entry-Level, Midrange Servers, Workstations,
%en Telco systems),
...
%en certified by Prometric Services
%pl certyfikat wydany przez  Prometric Services
...
%en Softskill Capgemini internal trainings:
%pl Wewnętrzne szkolenia softskillowe dla pracowników firmy Capgemini:
\begin{innerlist}
